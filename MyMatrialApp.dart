//
// Created by ckckck on 2018/9/20.
//
...
class LeftRightViewPageTransition extends StatelessWidget {
  LeftRightViewPageTransition({
    Key key,
    @required bool fade,
...
typedef Widget BuildTransition(
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation,
    ...
    if (_useCupertinoTransitions) {
      ...
      return buildTransition == null
          ? new LeftRightViewPageTransition(
...
class LeftRightMaterialApp extends StatefulWidget {
...
class _MaterialAppState extends State<LeftRightMaterialApp> {
  ...
  @override
  void didUpdateWidget(LeftRightMaterialApp oldWidget) {
  ...
  Route<dynamic> _onGenerateRoute(RouteSettings settings) {
    ...
    if (builder != null) {
      return new MyPageRoute<dynamic>(
        builder: builder,
        settings: settings,
      );
    }
